...
CFLAGS_PYEMBED = ['-g', '-fwrapv', '-O2', '-g', '-fstack-protector', '-g', '-flto', '-fuse-linker-plugin', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-pthread', '-g', '-fwrapv', '-O2', '-g', '-fstack-protector', '-g', '-flto', '-fuse-linker-plugin', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-g', '-fwrapv', '-O2', '-g', '-fstack-protector', '-g', '-flto', '-fuse-linker-plugin', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-pthread', '-g', '-fwrapv', '-O2', '-g', '-fstack-protector', '-g', '-flto', '-fuse-linker-plugin', '-fno-strict-aliasing']
...
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_INTTYPES_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_SYS_STAT_H': '', 'HAVE_DIRENT_H': '', 'HAVE_RT': '', 'HAVE_NETMAP_USER_H': '', 'HAVE_SYS_IOCTL_H': '', 'HAVE_SIGNAL_H': '', 'HAVE_UINT128_T': '', 'HAVE_SYS_TYPES_H': '', 'INT64X64_USE_128': '', 'PYTHONARCHDIR': '', 'HAVE_PACKET_H': '', 'HAVE_SEMAPHORE_H': '', 'HAVE_PTHREAD_H': '', 'HAVE_STDINT_H': '', 'HAVE_IF_TUN_H': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_PYTHON_H': '', 'HAVE_IF_NETS_H': '', 'PYTHONDIR': '', 'HAVE___UINT128_T': '', 'HAVE_GTK': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['udp', 'tutorial', 'udp-client-server', 'energy', 'socket', 'tcp', 'matrix-topology', 'naming', 'routing', 'stats', 'error-model', 'ipv6', 'realtime', 'wireless', 'traffic-control']
...
LIBPATH_PYTHON3.4M = ['/usr/lib/python3.4/config-3.4m-x86_64-linux-gnu']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
...
NS3_EXECUTABLE_PATH = ['/home/yash/ns-allinone-3.32/ns-3.32/build/src/fd-net-device', '/home/yash/ns-allinone-3.32/ns-3.32/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.9', '/home/yash/ns-allinone-3.32/ns-3.32/build/lib', '/home/yash/ns-allinone-3.32/ns-3.32/build']
...
cfg_files = ['/home/yash/ns-allinone-3.32/ns-3.32/build/ns3/config-store-config.h', '/home/yash/ns-allinone-3.32/ns-3.32/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
